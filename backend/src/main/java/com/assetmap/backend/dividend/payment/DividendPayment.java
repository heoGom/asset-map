package com.assetmap.backend.dividend.payment;
import com.assetmap.backend.dividend.event.DividendEvent;
import com.assetmap.backend.dividend.payment.dto.DividendPaymentUpdateRequest;
...
@Table(
		...
		uniqueConstraints = @UniqueConstraint(
				name = "uk_dividend_payment_user_account_security_event",
				columnNames = {"user_id", "account_id", "security_item_id", "dividend_event_id"}
		)
)
