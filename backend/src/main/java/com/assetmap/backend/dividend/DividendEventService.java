...
public class DividendEventService {
	...
	public DividendEventResponse create(DividendEventCreateRequest request) {
		...
		DividendEvent event = new DividendEvent(securityItem, request.dividendYear(), request.exDividendDate(), request.paymentDate(), request.dividendPerShare(), request.currency(), request.source());
