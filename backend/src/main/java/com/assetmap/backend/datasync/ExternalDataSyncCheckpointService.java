...
record MarketPriceCheckpointResult(
		LocalDate priceDate,
		String status,
	...
	static MarketPriceCheckpointResult success(LocalDate priceDate, SyncUpsertResult upsertResult, DataSyncStatusResponse status) {
	...
	static MarketPriceCheckpointResult noData(LocalDate priceDate, SyncUpsertResult upsertResult, DataSyncStatusResponse status) {
		return new MarketPriceCheckpointResult(priceDate, "NO_DATA", upsertResult, 0, 0, status.message(), status);
	}

	static MarketPriceCheckpointResult failed(LocalDate priceDate, String statusText, String message, DataSyncStatusResponse status) {
...
record StockDividendCheckpointResult(
		Long securityItemId,
		int year,
		String status,
	...
	static StockDividendCheckpointResult success(Long securityItemId, int year, DividendImportResult result, DataSyncStatusResponse status) {
		return new StockDividendCheckpointResult(securityItemId, year, "SUCCESS", result, 0, status.message(), status);
	}

	static StockDividendCheckpointResult noData(Long securityItemId, int year, DividendImportResult result, DataSyncStatusResponse status) {
		return new StockDividendCheckpointResult(securityItemId, year, "NO_DATA", result, 0, status.message(), status);
	}

	static StockDividendCheckpointResult failed(Long securityItemId, int year, DividendImportResult result, String message, DataSyncStatusResponse status) {
