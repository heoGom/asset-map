...
import com.assetmap.backend.datasync.plan.SyncNoDataCounts;
...
public class SyncPlanService {
	...
	public static final String TRADED_SECURITIES_PREFIX = AdminSyncService.TRADED_SECURITIES + "_";
	public static final String STOCK_DIVIDEND_PREFIX = "STOCK_DIVIDEND_";
